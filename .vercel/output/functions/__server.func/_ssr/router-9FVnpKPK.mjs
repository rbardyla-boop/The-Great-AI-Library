...
import { a as cn, f as selectDesk, v as useLibrary } from "./store-DYKIy7jQ.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/router-9FVnpKPK.js
...
function Gate() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: "M1 — The Library remembers without lying"
		})]
	});
}
var styles_default = "/assets/styles-DcLJAQrN.css";
...
function ShellGate() {
	...
	if (!entered) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Gate, {});
...
var $$splitComponentImporter$7 = () => import("./routes-DfCkHcEl.mjs");
var Route$7 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$7, "component") });
var $$splitComponentImporter$6 = () => import("./ask-B9kyrsR2.mjs");
