...
import { r as Button, y as cn } from "./router-8dUCwk1E.mjs";
import { t as createServerFn } from "./ssr.mjs";
import { t as Badge } from "./badge-DGoUUdzQ.mjs";
import { t as HashStamp } from "./hash-stamp-CDt47k5x.mjs";
import { t as createSsrRpc } from "./createSsrRpc-C1p7zOu_.mjs";
import { i as replayDecision, n as convene, r as recordDecision, s as useChamber, t as DILEMMAS } from "./store-arNVShLr.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/chamber-7sYdAqfI.js
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", { children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: "Six roles, one checkpoint. VALUES recommend. The Hive membrane authorizes — or does not. An agent may change its mind. It may not silently change the constitution."
				})
			] }),
...
function ReplayButton({ dilemmaId, onDone }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
		...
		onClick: async () => {
			...
			const { evaluateValues } = await import("./store-arNVShLr.mjs").then((n) => n.d).then((n) => n.n);
			const { profileByRole } = await import("./store-arNVShLr.mjs").then((n) => n.u).then((n) => n.i);
			const v13 = await profileByRole("builder", "1.3.0");
			const decision = recordDecision(dilemma, evaluateValues(v13, dilemma), 0);
			const { replayed } = await replayDecision(decision, "values://open-hive/builder/1.4.0");
			onDone(`Builder 1.3.0 → ${decision.judgment.recommendation}. Replay under 1.4.0 → ${replayed.recommendation}. The original receipt is unchanged. Only the judging constitution moved — through epoch, not silently.`);
		},
		children: "Replay under 1.4.0"
	});
}
