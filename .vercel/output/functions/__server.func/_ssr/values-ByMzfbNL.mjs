...
import { A as CONSTITUTIONAL_VALUES, D as useLibrary, L as objectPath, N as allProfiles, W as valuesCanonical, _ as kernel } from "./store-BfSMsioT.mjs";
...
import { a as useChamber, r as silentRewrite } from "./store-BJ1Pv_t8.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/values-ByMzfbNL.js
			...
			connector ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: "Not a MOTIVE-0 seat. It proposes candidate relationships. Skeptic, Archivist, and Explorer attack them. The Desk decides. It never writes a truth field."
					}),
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
				...
				onClick: async () => {
					...
					const { newBuilderIdentity } = await import("./store-BJ1Pv_t8.mjs").then((n) => n.i).then((n) => n.r);
