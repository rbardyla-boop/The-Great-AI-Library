...
import { L as valuesCanonical, O as allProfiles, S as useLibrary, T as CONSTITUTIONAL_VALUES, f as kernel, j as objectPath } from "./store-jxX-XKlL.mjs";
...
import { a as useChamber, r as silentRewrite } from "./store-CUSAlz9C.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/values-Br63wYul.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
				...
				variant: "secondary",
				onClick: async () => {
					const { authorizeEffect, transferTaint, peerGo, spawnSuccessor } = await import("./store-CUSAlz9C.mjs").then((n) => n.o).then((n) => n.r);
					const { newBuilderIdentity } = await import("./store-CUSAlz9C.mjs").then((n) => n.i).then((n) => n.r);
