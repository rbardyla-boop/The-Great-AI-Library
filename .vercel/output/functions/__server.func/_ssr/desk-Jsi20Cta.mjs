import { E as selectRecords, O as useLibrary, v as kernel, w as selectDesk } from "./store-DNWQlu4d.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/desk-Jsi20Cta.js
			...
			openHyps.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: "Connect-the-Dots does not judge itself. A high score is not evidence. SUPPORTED cites local review or support receipts. Analogies and gaps stay hypotheses. Keep open leaves the original CONNECT untouched."
					}),
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
						...
						children: openHyps.map((c) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ConnectionCard, {
							...
							onSupport: () => void support(c.id, "Desk filed local support. Ranking is not evidence.", "Archivist")
						}) }, c.hash || c.id))
					})
				]
			}) : null,
