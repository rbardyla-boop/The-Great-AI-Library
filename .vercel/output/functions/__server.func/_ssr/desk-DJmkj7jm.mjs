import { C as selectDesk, D as useLibrary, T as selectRecords } from "./store-BfSMsioT.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/desk-DJmkj7jm.js
...
function Desk() {
	...
	const openHyps = hypotheses.filter((c) => c.status === "HYPOTHESIS" || c.status === "CONTESTED").slice().sort((a, b) => a.search === "FAR" ? -1 : 1);
			...
			openHyps.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: "Connect-the-Dots does not judge itself. Promote tries to make a fact and should fail for analogies and gaps. Keep open leaves the original CONNECT untouched."
					}),
