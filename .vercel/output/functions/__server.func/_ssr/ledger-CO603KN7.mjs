...
import { a as fromUtf8, f as utf8, l as sha256Bytes, r as bytesEqual } from "./crypto-CPnHmxyK.mjs";
import { B as require_react, b as require_jsx_runtime } from "../_libs/@tanstack/react-router+[...].mjs";
import { C as validateBag, E as signLibrarian, S as restoreBag, b as LibraryKernel, f as useLibrary, i as kernel, r as Button, u as selectLedger, w as GAL_PUBLISHER, x as exportBag, y as valuesLedgerEvents } from "./router-lsvE-Cg6.mjs";
...
import { s as dotsLedgerEvents } from "./registry-BLlwdRIE.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/ledger-CO603KN7.js
			...
			dotsEvents.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: "CONNECT files a hypothesis. Reviews travel as gal://review objects. SUPPORT splits into OPINION and EVIDENTIARY. Opinion contributes zero. A REVIEW_SET receipt records exactly what this Library considered. HMAC is integrity, not trust."
					}),
...
function PayloadLine({ command, payload }) {
	...
	if (command === "REVIEW_SET" || command === "IMPORT_REVIEW") return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
		className: "mt-1 break-all font-mono text-[11px] text-faint",
		children: [
			str(payload.reviewUri) || str(payload.uri),
			" · policy ",
			str(payload.policyVersion),
			" · decision ",
			str(payload.decision),
			" · reviews ",
			String(payload.reviewHashes?.length ?? ""),
			" ",
			"· ",
	...
	if (command === "CHALLENGE" || command === "SUPPORT" || command === "FALSIFY" || command === "PROMOTE" || command === "KEEP_OPEN" || command === "REVIEW") return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
		...
		children: [
			...
			" ·",
			" ",
			str(payload.supportClass) || "—",
			" · contribution ",
			String(payload.evidentiaryContribution ?? 0),
			" · original ",
