...
import { B as sha256Bytes, D as useLibrary, E as signLibrarian, I as fromUtf8, O as validateBag, P as bytesEqual, U as utf8, _ as kernel, a as GAL_PUBLISHER, d as exportBag, k as valuesLedgerEvents, o as LibraryKernel, w as selectLedger, y as restoreBag } from "./store-BfSMsioT.mjs";
...
import { a as dotsLedgerEvents } from "./registry-BrzUp8iI.mjs";
import { t as auditAnswer } from "./auditor-Cg9dLHe4.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/ledger-D3J0SoQ0.js
			...
			dotsEvents.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: "CONNECT files a hypothesis. CHALLENGE, SUPPORT, FALSIFY, and PROMOTE cite that receipt. Replay is not rewrite. There is no truth field."
					}),
...
function PayloadLine({ command, payload }) {
	...
	if (command === "CONNECT" || command === "IMPORT_HYPOTHESIS") return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
		className: "mt-1 font-mono text-[11px] text-faint",
		children: [
	...
	if (command === "CHALLENGE" || command === "SUPPORT" || command === "FALSIFY" || command === "PROMOTE" || command === "KEEP_OPEN") return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
		className: "mt-1 font-mono text-[11px] text-faint",
		children: [
			str(payload.connectionId),
			" · ",
			str(payload.fromStatus),
			" → ",
			str(payload.toStatus) || str(payload.status),
			" ",
			"· original ",
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(HashStamp, { hash: str(payload.originalReceipt) || str(payload.originalHash) })
		]
	});
	return null;
}
