...
import { i as cn } from "./store-jxX-XKlL.mjs";
...
import { a as useChamber, n as convene, t as DILEMMAS } from "./store-CUSAlz9C.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/chamber-Da6fKViA.js
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", { children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: "Six roles, one checkpoint. VALUES recommend under cost. The Hive membrane authorizes — or does not. An agent may change its mind. It may not silently change the constitution."
				})
			] }),
