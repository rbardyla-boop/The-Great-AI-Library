...
import { F as canonicalJson, R as profileByRole, V as sha256Text, _ as kernel, c as RELATIONSHIPS, i as ENTITIES, l as cn, n as CLAIMS, r as CONTRADICTIONS, s as RECORDS, u as evidenceRoot, v as refreshLibrary } from "./store-BfSMsioT.mjs";
...
import { c as fileDiscovery, d as filePromote, f as fileSupport, g as unsignedConnection, h as reviewConnection, i as connectionsFromLedger, l as fileFalsify, m as hashConnection, n as DOTS_EVALUATOR, o as fileChallenge, p as hasTruthField, r as connectionCanonical, s as fileConnect, t as DOTS_CHECKPOINT, u as fileKeepOpen } from "./registry-BrzUp8iI.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/store-DNg3nOdC.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
function exportCard(connection) {
	const card = {
		protocol: "gal-dots/0",
		connection: {
...
async function parseCard(text) {
	...
	const raw = parsed.connection ?? parsed;
	if (hasTruthField(raw) || hasTruthField(parsed)) return {
		ok: false,
...
function ConnectionCard({ connection, reviews, onReview, onChallenge, onPromote, onKeepOpen }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				children: connection.status === "SUPPORTED" ? "Supported hypothesis — not library fact" : "Hypothesis — not library fact"
			}),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
						...
						children: copied ? "Card copied" : "Export card"
					})
				]
			}),
...
var useDots = create()(persist((set, get) => ({
	...
	challenge: async (id, reason, role) => {
		...
		if (get().lastReport) set({ lastReport: {
			...get().lastReport,
