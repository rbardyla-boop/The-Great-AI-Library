...
import { I as canonicalJson, R as hmacSha256, V as profileByRole, W as sha256Text, c as RECORDS, d as evidenceRoot, i as ENTITIES, l as RELATIONSHIPS, n as CLAIMS, o as GAL_PUBLISHER_KEY, r as CONTRADICTIONS, u as cn, v as kernel, y as refreshLibrary, z as hmacSha256Verify } from "./store-DNWQlu4d.mjs";
...
import { _ as hashConnection, a as connectionUri, b as unsignedConnection, c as fileChallenge, d as fileKeepOpen, f as filePromote, g as hasTruthField, h as fileSupport, i as connectionCanonical, l as fileDiscovery, m as fileReviewReceipt, n as DOTS_EVALUATOR, o as connectionsFromLedger, p as fileReplicate, r as LOCAL_LIBRARY_ID, t as DOTS_CHECKPOINT, u as fileFalsify, v as lineageFor, y as reviewConnection } from "./registry-BNn70Ua5.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/store-BviDRNMf.js
...
function ConnectionCard({ connection, reviews, onReview, onChallenge, onPromote, onKeepOpen, onSupport, onFalsify }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				children: "Scores rank. They are not evidence. SUPPORTED cites receipts."
			}),
			cited.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
						...
						children: copied ? "Envelope copied" : "Export envelope"
					})
				]
			}),
...
var useDots = create()(persist((set, get) => ({
	...
	support: async (id, reason, role) => {
		...
		set({ notice: `SUPPORT filed against ${connectionUri(connection.hash)}. Artifact unchanged. Not consensus.` });
		refreshLibrary();
	},
