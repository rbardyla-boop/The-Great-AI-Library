...
import { o as connectionsFromLedger } from "./registry-BNn70Ua5.mjs";
import { n as useDots, t as ConnectionCard } from "./store-BviDRNMf.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/dots-panel-CJNiHQop.js
...
function DotsPanel({ query }) {
	...
	const connections = (connectionsFromLedger(kernel).length ? connectionsFromLedger(kernel) : lastReport?.connections ?? []).slice().sort((a, b) => {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: "DOTS-1 — Network without consensus"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-1 max-w-xl text-sm leading-relaxed text-muted",
					children: "Portable hypotheses travel as HYPOTHESIS. Challenge, support, falsify, and replicate cite the hash. Ten thousand agreements are not a fact. Strength ranks. It does not prove."
			...
			connections.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
				...
				children: connections.map((c) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ConnectionCard, {
					...
					onSupport: () => void support(c.id, "Local support. Ranking is not evidence. This is a receipt, not consensus.", "Archivist"),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: "Import a hypothesis envelope"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "mt-1 text-sm text-muted",
						children: "Stranger import is REPLICATE. Same bytes, local conclusion empty. Ten thousand SUPPORT objects still do not promote. A live agent mesh is not this page."
					}),
