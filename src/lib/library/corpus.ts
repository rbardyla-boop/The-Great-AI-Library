...
function rec(
  partial: Omit<LibraryRecord, "contentHash" | "kind" | "accessPolicy" | "tags"> &
    Partial<Pick<LibraryRecord, "kind" | "accessPolicy" | "tags" | "contentHash">>,
): LibraryRecord {
  return {
    kind: "original",
    accessPolicy: "open",
...
export const CLAIMS: Claim[] = [
  ...
  },
  {
    ...
    status: "current",
    temporal: "is_true",
    entities: ["ent-mercury", "ent-chen", "ent-hale"],
  ...
  },
  {
    ...
    passage:
      "Project Mercury is a grid-scale thermal storage program at the Helios Institute. It is named for the working fluid — a mercury-free molten salt loop — and has no relation to the NASA program of the same name.",
    page: 1,
    assertedAt: "2024-03-04",
    validFrom: "2024-03-04",
    status: "current",
  ...
  },
  {
    ...
    passage:
      "Effective 8 May 2025, the authorized budget for Project Mercury is $72 million. This supersedes the 4 March 2024 proposal figure of $48 million, which is now obsolete.",
    page: 1,
  ...
  },
  {
    ...
    passage:
      "Helios Institute's Project Mercury, the thermal storage bet once sold as a $48 million science project, will cost $90 million, according to an unnamed staffer who reviewed internal spreadsheets.",
  ...
  },
  {
    ...
    passage:
      "The authorized budget for Project Mercury is $72 million, as recorded in the 8 May 2025 addendum. A 12 June report citing $90 million is incorrect.",
  ...
  },
  {
    ...
    passage:
      "Drop the second test cell and Mercury returns to a $31 million program, East Bay Climate Watch estimates from public addendum line items.",
  ...
  },
  {
    ...
    passage:
      "We report a chloride-salt loop operating at 410°C with acceptable corrosion on 316L over 2,000 hours. This result informed early Project Mercury materials choices.",
    assertedAt: "2023-08-19",
    validFrom: "2023-08-19",
    validTo: "2025-11-01",
    status: "retracted",
    temporal: "obsolete",
    entities: ["ent-okonkwo", "ent-chen", "ent-mercury"],
    topics: ["materials"],
    strength: "primary",
  },
  {
  ...
  },
  {
    ...
    passage:
      "Project Mercury will recoup its investment in 11 months and is fully de-risked on materials.",
  ...
  },
  {
    ...
    passage:
      "Naomi Chen and Marcus Hale jointly invented the architecture in 2023.",
    assertedAt: "2026-04-02",
    validFrom: "2026-04-02",
    status: "unsupported",
    temporal: "was_claimed",
    entities: ["ent-chen", "ent-hale", "ent-mercury"],
  ...
  },
  {
    ...
    passage:
      "Small modular reactors will be commercially dominant by 2026. Several Western vendors have announced first-concrete dates inside that window.",
  ...
  },
  {
    ...
    passage:
      "Contractors may copy original sources to personal laptops for offline analysis. Cloud sync of those copies is discouraged but not forbidden.",
  ...
  },
  {
    ...
    passage:
      "Contractors may not copy original evidence off-device. Derivatives may be exported.",
  ...
  },
  {
    ...
    passage:
      "Contract value: $12 million for two pressure vessels supporting Project Mercury test cells. This line is part of the $72 million authorized addendum, not an additional $90 million.",
  ...
  },
  {
    ...
    passage:
      "Lab 3 air monitors picked up elemental mercury vapour after a broken manometer. This is the element Hg, not Project Mercury.",
  ...
  },
  {
    ...
    passage:
      "The authorized budget for Project Mercury is $79 million, as recorded in the 8 May 2025 addendum.",
    assertedAt: "2025-06-13",
    validFrom: "2025-06-13",
    status: "disputed",
    temporal: "was_claimed",
...
export const CONTRADICTIONS: Contradiction[] = [
  {
    id: "X-budget",
    claimIds: ["C10040", "C11090", "C11092"],
    title: "Mercury budget figures do not agree",
    summary:
      "Authorized addendum: $72M. Valley Ledger unnamed staffer: $90M. Climate Watch should-be: $31M. The 2024 $48M ask is superseded, not a fourth current figure.",
    status: "open",
  },
  {
    id: "X-origin",
    claimIds: ["C9822", "C9901", "C13002"],
    title: "Who invented Mercury",
    summary:
      "Chen's proposal and Hale's notes agree: Chen originated, Hale requested. An AI summary claims joint invention in 2023 with no supporting passage.",
    status: "open",
  },
  {
    id: "X-payback",
    ...
    summary:
      "Finance addendum forbids payback claims. A derived executive summary asserts 11-month recoupment without a primary passage.",
    status: "open",
  },
  {
    id: "X-integrity",
    ...
    summary:
      "Original brief: $72 million. Later recapture: $79 million. Same URI, different bytes. Integrity event, not a new official figure.",
    status: "open",
  },
];

export const RELATIONSHIPS: Relationship[] = [
  { id: "rel-1", fromId: "ent-chen", toId: "ent-mercury", kind: "originated", recordId: "doc-proposal", derived: false },
  { id: "rel-2", fromId: "ent-hale", toId: "ent-mercury", kind: "commissioned", recordId: "doc-kickoff", derived: false },
  { id: "rel-3", fromId: "ent-helios", toId: "ent-mercury", kind: "hosts", recordId: "doc-proposal", derived: false },
  { id: "rel-4", fromId: "ent-northline", toId: "ent-mercury", kind: "contracted-for", recordId: "doc-contract", derived: false },
  { id: "rel-5", fromId: "ent-okonkwo", toId: "ent-mercury", kind: "materials-lead", recordId: "doc-kickoff", derived: false },
  { id: "rel-6", fromId: "ent-rivera-j", toId: "ent-mercury", kind: "reported-on", recordId: "doc-ledger-article", derived: false },
  { id: "rel-7", fromId: "ent-rivera-e", toId: "ent-hg", kind: "logged", recordId: "doc-lab-mercury", derived: false },
  { id: "rel-8", fromId: "ent-cat", toId: "ent-mercury", kind: "homonym-of", derived: true },
  { id: "rel-9", fromId: "ent-hg", toId: "ent-mercury", kind: "homonym-of", derived: true },
];
...
export const DESK_ITEMS: DeskItem[] = [
  {
    ...
    relatedIds: ["X-budget", "C10040", "C11090", "C11092", "C9821"],
  },
  {
    ...
    relatedIds: ["X-origin", "C9822", "C13002"],
  },
  {
  ...
  },
  {
    ...
    relatedIds: ["X-integrity", "doc-brief", "doc-brief-altered"],
  },
  {
  ...
  },
  {
    ...
    relatedIds: ["ent-mercury", "ent-hg", "ent-cat"],
  },
  {
    id: "desk-integrity",
    kind: "integrity",
  ...
  },
  {
    ...
    relatedIds: ["doc-ai-summary", "C13001", "C13002"],
  },
  {
    id: "desk-stale",
    kind: "stale",
    ...
    relatedIds: ["doc-nuclear-2024", "doc-nuclear-2026", "C14001", "C14002"],
  },
  {
    id: "desk-changed",
    kind: "changed",
    ...
    relatedIds: ["doc-retracted", "C12001", "C12002"],
  },
];
